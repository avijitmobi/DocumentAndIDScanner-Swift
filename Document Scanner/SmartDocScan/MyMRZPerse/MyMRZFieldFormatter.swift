...
class MyMRZFieldFormatter {
    ...
    // MARK: Main
    func field(_ fieldType: MyMRZFieldType, from string: String, at startIndex: Int, length: Int, checkDigitFollows: Bool = false) -> MRZField {
    ...
    func format(_ string: String, as fieldType: MyMRZFieldType) -> Any? {
        switch fieldType {
        case .names:
    ...
    func correct(_ string: String, fieldType: MyMRZFieldType) -> String {
        switch fieldType {
